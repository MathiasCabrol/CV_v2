...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center">
            <div class="normalText col-12 col-md-8 col-lg-8 col-xl-8 text-center">
            ...
            <div class="col-12 col-md-12 col-lg-12 col-xl-12 text-center iconsCol mb-5">
            ...
            <div class="col-12 col-md-12 col-lg-12 col-xl-12 text-center iconsCol">
            ...
            <div class="col-8 col-md-8 col-lg-8 col-xl-8 text-center mt-3">
                <h2 class="skillsSubTitle mt-5">Formation</h2>
                <div class="col-12 col-md-12 col-lg-12 col-xl-12 experienceCol mt-4">
